...
const courses = [
  {
    title: "Cook Course",
    image: "https://images.unsplash.com/photo-1556911261-6bd341186b2f?w=900&auto=format&fit=crop&q=60",
  },
  {
    title: "How to be organized",
  ...
  {
    title: "Street Art",
    image: "https://images.unsplash.com/photo-1583225214464-9296029427aa?w=900&auto=format&fit=crop&q=60",
  },
  {
    title: "Photography",
    image: "https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=900&auto=format&fit=crop&q=60",
  },
  {
    title: "Video Editing",
    image: "https://images.unsplash.com/photo-1526698905402-e13b880ad864?w=900&auto=format&fit=crop&q=60",
  },
  {
    title: "Business Course",
...
const CourseImage = ({ course }: { course: courseProps }) => {
  return (
    <div className="w-full max-w-[410px] h-[260px] rounded-xl border-2 mx-4 group relative overflow-hidden">
      <span className="opacity-0 duration-300 group-hover:opacity-100 absolute z-50 bottom-0 left-0 text-foreground bg-background px-4 py-2 text-lg rounded-tr-xl font-bold">
        {course.title}
      </span>
      <Image
        width={1000}
...
export default async function Page() {
  const { userId } = auth(); // ✅ This now runs safely on the server

  return (
    <div className="flex flex-col gap-6">
      <section className="flex flex-col items-center justify-center h-full container gap-6 pt-10 md:pt-24 lg:pt-36">
        <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-6xl text-center max-w-5xl">
          Teaching in the Internet age means we must teach{" "}
          <span className="text-blue-600 font-bold">tomorrow&apos;s</span> skills today
        </h1>
        <p className="text-muted-foreground text-sm md:text-base max-w-3xl text-center font-light">
          BUILD BY <span className="text-blue-500 font-bold">HARSH</span>, <span className="text-blue-500 font-bold">RANIT</span>,{" "}
          <span className="text-blue-500 font-bold">KHYRUDDIN</span>, <span className="text-blue-500 font-bold">AMISH</span>,{" "}
          <span className="text-blue-500 font-bold">PRASENJIT</span>..
        </p>
        <div className="flex items-center justify-center gap-3">
          {userId ? (
            <Link
      ...
      {/* Removed marquee & replaced with optional placeholder */}
      <section className="w-full h-[500px] relative overflow-hidden">
        ...
        >
          <source src="https://videos.pexels.com/video-files/857195/857195-hd_1280_720_30fps.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>
        <div className="relative z-10 flex items-center justify-center h-full text-white text-3xl font-semibold">
